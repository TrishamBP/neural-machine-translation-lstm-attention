...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Trisham\Desktop\Study\Python\nmt-lstm-attention\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Trisham\Desktop\Study\Python\nmt-lstm-attention\venv\Scripts\deactivate.nu'
